...
export default defineConfig({
    ...
    build: {
        ...
        rollupOptions: {
            ...
            output: {
                // Single entry bundle (Rolldown): avoids async vendor chunk doing
                ...
                // Replaces deprecated output.inlineDynamicImports.
                codeSplitting: false,
    ...
    fmt: {
        // 4-space indent for TS/JS (matches .editorconfig); other file types
        // (CSS, JSON, Markdown) keep oxfmt's 2-space default.
        overrides: [
            {
