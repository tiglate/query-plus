...
describe("ThemeService", () => {
    ...
    it("applies selection and persists preference", () => {
        ...
        expect(document.querySelector("[data-theme-icon]")!.classList.contains("fa-moon")).toBe(
            true,
        );
        ...
        expect(document.querySelector("[data-theme-icon]")!.classList.contains("fa-sun")).toBe(
            true,
        );
